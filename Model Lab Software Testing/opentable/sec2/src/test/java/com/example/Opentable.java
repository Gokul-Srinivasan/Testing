...
public class Opentable {
    ...
    public void test1() throws IOException, InterruptedException{
        PropertyConfigurator.configure("C:\\Users\\91638\\Downloads\\Model ST\\Model\\opentable\\sec2\\src\\main\\resources\\log4j2.properties");
        FileInputStream fs = new FileInputStream("C:\\Users\\91638\\Downloads\\Model ST\\Model\\opentable\\sec2excel.xlsx");
        ...
        Thread.sleep(2000);
        WebElement sel=driver.findElement(By.xpath("//*[@id='restProfileMainContenttimePickerDtpPicker']"));
        Select select1=new Select(sel);
        select1.selectByVisibleText("6:30 PM");
        File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        String path = "D:\\Software Testing\\Model\\pro3\\sec2log\\image.png";
